...
export const fetchCommentsByVideoId = createAsyncThunk(
  ...
  async (videoId) => {
    const response = await axios.get(`https://tube-aoyd.onrender.com/api/v1/comments/video/${videoId}`);
...
export const addComment = createAsyncThunk(
  ...
  async ({ videoId, comment }) => {
    const response = await axios.post(`https://tube-aoyd.onrender.com/api/v1/comments/video/${videoId}`, { comment });
...
export const deleteComment = createAsyncThunk(
  ...
  async ({ videoId, commentId }) => {
    await axios.delete(`https://tube-aoyd.onrender.com/api/v1/comments/${commentId}`);
...
export const updateComment = createAsyncThunk(
  ...
  async ({ videoId, commentId, newComment }) => {
    const response = await axios.put(`https://tube-aoyd.onrender.com/api/v1/comments/${commentId}`, { newComment });
